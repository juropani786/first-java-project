...
public class ClassConditional {
	...
	//if the outer condition is met then only it goes to the inner conditional statement.
	//the execution goes inside the inner conditional statement if outer conditional statement is true
